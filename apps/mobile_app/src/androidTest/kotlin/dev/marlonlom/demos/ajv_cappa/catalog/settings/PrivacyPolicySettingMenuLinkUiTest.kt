...
class PrivacyPolicySettingMenuLinkUiTest {
  ...
  fun shouldClickThirdPartySoftwareSettingMenuLink() {
    ...
    composeTestRule.onNodeWithText("Privacy policy").assertExists().performClick()
  }
